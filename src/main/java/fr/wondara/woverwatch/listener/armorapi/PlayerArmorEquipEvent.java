 ...
 * @since Jul 30, 2015
 */
public final class PlayerArmorEquipEvent extends PlayerEvent implements Cancellable{
    ...
    /**
     * Constructor for the PlayerArmorEquipEvent.
     *
    ...
    /**
     * Gets a list of handlers handling this list.
     *
     * @return A list of handlers handling this list.
     */
    ...
    /**
     * Sets if this list should be cancelled.
     *
     * @param cancel If this list should be cancelled.
     */
    ...
    /**
     * Gets if this list is cancelled.
     *
     * @return If this list is cancelled
     */
